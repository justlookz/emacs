...
(defcustom monokai-green-d "#75715E"
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive
     ((,monokai-class (:inverse-video unspecified
      ...
      (,monokai-256-class (:inverse-video unspecified
                                           :underline unspecified
                                           :foreground ,monokai-256-green-d
                                           :background ,monokai-256-background
                                           :box (:line-width 1
   ...
   `(flymake-popon-note
     ((,monokai-class (:inherit flymake-popon :foreground ,monokai-green-d))
      (,monokai-256-class (:inherit flymake-popon :foreground ,monokai-256-green-d))))
   ...
   `(tty-menu-disabled-face
     ((,monokai-class (:foreground ,monokai-green-d :background ,monokai-gray-d))
      (,monokai-256-class (:foreground ,monokai-256-green-d :background ,monokai-256-gray-d))))
